...
{{
    ...
    {{
        {(syntaxReceiver.enableCrossEntityTransactions
            ? "await endpoint.ProcessTransactional(message, messageReceiver, logger, cancellationToken);"
            : "await endpoint.ProcessNonTransactional(message, messageReceiver, logger, cancellationToken);")}
    }}
}}";
