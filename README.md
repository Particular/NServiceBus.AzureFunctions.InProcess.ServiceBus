...
> New projects should use the [isolated worker model](https://docs.particular.net/nservicebus/hosting/azure/functions/) instead. To migrate:
> 1. Update to [`NServiceBus.AzureFunctions.Worker.ServiceBus`](https://docs.particular.net/nservicebus/upgrades/azure-functions-service-bus-in-process-isolated-worker).
> 2. Update to [`NServiceBus.AzureFunctions.AzureServiceBus`](https://docs.particular.net/nservicebus/upgrades/azure-functions-service-bus-isolated-to-azure-functions).
