...
{{
    ...
    public async Task Run(
        [ServiceBusTrigger(queueName: ""{syntaxReceiver.endpointName}"", AutoCompleteMessages = {(!syntaxReceiver.enableCrossEntityTransactions).ToString().ToLowerInvariant()})]
    ...
    {{
        await endpoint.Process(message, executionContext, client, messageActions, {syntaxReceiver.enableCrossEntityTransactions.ToString().ToLowerInvariant()}, logger,cancellationToken);
    }}
}}";
