namespace NServiceBus.AzureFunctions.InProcess.ServiceBus
{
    ...
    class DeferredLogger : ILog
    {
        ...
        // capturing everything if the logger is not yet set
        public bool IsDebugEnabled => logger?.IsDebugEnabled ?? true;
        public bool IsInfoEnabled => logger?.IsInfoEnabled ?? true;
        public bool IsWarnEnabled => logger?.IsWarnEnabled ?? true;
        public bool IsErrorEnabled => logger?.IsErrorEnabled ?? true;
        public bool IsFatalEnabled => logger?.IsFatalEnabled ?? true;
