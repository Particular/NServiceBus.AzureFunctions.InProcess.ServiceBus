namespace Testing.Handlers
{
    ...
    /**
     * This types are used to test the assembly scanning logic which is required to load additional handler assemblies
     * which are optimized away when they calling code doesn't explicitly reference a type from the assembly.
