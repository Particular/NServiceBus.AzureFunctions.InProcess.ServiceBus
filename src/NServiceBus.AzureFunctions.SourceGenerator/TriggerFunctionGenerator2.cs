...
<<<<<<< HEAD:src/NServiceBus.AzureFunctions.SourceGenerator/TriggerFunctionGenerator2.cs
            var source =
$@"// <autogenerated/>
...
>>>>>>> 6fca7ee (Update to Microsoft.Azure.WebJobs.Extensions.ServiceBus 5.2.0 (#393)):src/NServiceBus.AzureFunctions.SourceGenerator/TriggerFunctionGenerator.cs
...
{{
    ...
    {{
<<<<<<< HEAD:src/NServiceBus.AzureFunctions.SourceGenerator/TriggerFunctionGenerator2.cs
        await endpoint.Process(message, executionContext, messageReceiver, {syntaxReceiver.enableCrossEntityTransactions.ToString().ToLowerInvariant()}, logger);
=======
